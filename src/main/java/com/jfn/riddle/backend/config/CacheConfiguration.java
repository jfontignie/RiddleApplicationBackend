package com.jfn.riddle.backend.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jfn.riddle.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jfn.riddle.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE);
